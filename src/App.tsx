...
export default function App() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-theme-bg text-theme-text">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none fixed right-[4.875rem] top-0 hidden h-[calc(40%-6rem)] w-0.5 bg-theme-border/70 lg:block"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none fixed right-[4.875rem] bottom-0 hidden h-[calc(40%-6rem)] w-0.5 bg-theme-border/70 lg:block"
      />
